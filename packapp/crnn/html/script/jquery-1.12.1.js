...
function(a, b) {
    ...
    n.parseXML = function(b) {
        ...
        try { (a.DOMParser && !(window.navigator.userAgent.indexOf("MSIE 9.0") > 0)) ? (d = new a.DOMParser, c = d.parseFromString(b, "text/xml")) : (c = new a.ActiveXObject("Microsoft.XMLDOM"), c.async = "false", c.loadXML(b))
        } catch(e) {
            c = void 0
        }
    ...
    "function" == typeof define && define.cmd && define("lib/jquery/jquery/jquery-1.12.1.min", [],
    function() {
        return n;
    });
    var mc = a.jQuery,
